...
public interface CobinhoodWalletAPI {
    ...
    Call<CobinResponse<List<Balance>>> getWalletBalances(
    ...
    Call<CobinResponse<List<Ledger>>> getLedgerEntries(
            @Header("Authorization") String authorization,
    ...
    Call<CobinResponse<List<Address>>> getDepositAddresses(
            @Header("Authorization") String authorization
    );
    ...
    Call<CobinResponse<List<Address>>> getWithdrawalAddresses(
            @Header("Authorization") String authorization
    );
    ...
    Call<CobinResponse<Withdrawal>> getWithdrawal(
            @Header("Authorization") String authorization,
            @Path("withdrawal_id") String withdrawalId
    );
    ...
    Call<CobinResponse<List<Withdrawal>>> getWithdrawals(
            @Header("Authorization") String authorization,
            @Query("page") Integer page,
            @Query("limit") Integer limit
    );
    ...
    Call<CobinResponse<Deposit>> getDeposit(
            @Header("Authorization") String authorization,
            @Path("deposit_id") String depositId
    );
    ...
    Call<CobinResponse<List<Deposit>>> getDeposits(
            @Header("Authorization") String authorization
    );
